            ...
            <div className="sticky left-0 top-0 w-full py-4 px-10 z-10">
                ...
                >
                    ...
                    <ul className="hidden text-black sm:flex">
                        ...
                        <li className="m-1 p-2 btn btn-text">
                            <Link className="noselect" href="/about">
                                About
                            </Link>
                        </li>
                        <li className="m-1 p-2 btn btn-text">
                            <Link className="noselect" href="/contact">
                                Contact
                            </Link>
                        </li>
                        <li className="m-1 p-2 btn btn-primary">
                            <Link className="noselect" href="/apply">
                                Apply Now
                            </Link>
                        </li>
                    </ul>
                    ...
                    <div
                        className={
                            nav
                                ? "sm:hidden absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center w-full h-screen bg-black text-center ease-in duration-300 scale-125"
