                            ...
                            <div className="md:flex items-center">
                                <div className="md:max-w-[480px] md:min-w-[420px] md:pr-4 lg:min-w-[540px] lg:pr-10">
                                    ...
                                    <p className="text-base md:text-lg text-[#1d1004] mt-6 pointer-events-none">
                                        Our programs offer the most effective learning for children by focusing on individual needs. Each program is carefully
                                        crafted to nurture and develop every child's unique abilities. Join us to experience a personalized approach to early
                                        education.
                                    </p>
                                    ...
                                    <Link className="btn btn-text" href="/program" scroll={false}>
                                        ...
                                        <Button as={Link} color="primary" variant="light" href="/about" endContent={<FaArrowRight />}>
                                            Learn About Us
                                        </Button>
                                    </div>
                                </div>
                                <div className="flex mt-16 md:mt-0 md:max-h-[648px] md:flex-1 justify-center md:justify-end m-auto relative">
                                    <Image
                                        ...
                                        placeholder="blur"
                                        // style={imageStyle1}
                                        className="rounded-2xl object-cover md:h-full md:max-h-[480px] md:w-auto lg:left"
